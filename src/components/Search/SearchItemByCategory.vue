    ...
    <b-container id="search">
        ...
        <template v-if="show">
            <b-row class="p-1">
                ...
                <b-col sm="10">
                    <b-form-select v-model="categoryName" :value="null" :options="categorySelection">
                    </b-form-select>
        ...
        methods: {
            ...
            searchItem() {
                ...
                if (this.categoryName) {
                    axios.get(config.vueConfig.ip + '/item/get/category?categoryName=' + this.categoryName).then((response) => {
                        if (response.data[0]) {
